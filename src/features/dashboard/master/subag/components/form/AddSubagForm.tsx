...
export interface AddSubagFormProps {
  onCloseModal: () => void;
}
...
const AddSubagForm = ({ onCloseModal }: AddSubagFormProps) => {
  const form = useForm();

  return (
    <div className="ds-modal-box">
      <h3 className="font-bold text-lg">Tambah Data Sub. Bagian</h3>
